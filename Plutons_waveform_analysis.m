...
P1 = [x_of_sta(1),y_of_sta(1), elev(1)*1000]; %first station coordinates (UTM) and elevation
P2 = [x_on_line(2), y_on_line(2), elev(1)*1000]; %point (UTM) on intersecting line at elevation of first station
P3 = [third_point_x, third_point_y, elev(1)*1000-10]; %point along the plane under the surface of the earth
