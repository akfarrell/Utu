function visualization_delays(w_clean_sort,delay_vals, mean_delay,name,fil,az,eq_number, slowness)
...
%       azimuth origin
%
%   Author: Alexandra Farrell 2016/3/15 using mapping toolbox and border
